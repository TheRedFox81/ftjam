...
SOURCES = \
	...
	newstr.c option.c parse.c pathunix.c pathvms.c regexp.c rope.c \
	rules.c scan.c search.c spawn.c spawnmac.c spawnnt.c spawnos2.c \
	spawnunix.c timestamp.c variable.c
